...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.tmake.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".tmake" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".tmake")
	}
